 ...
 Token t;
    ...
    while (true) {
      ...
      case FALSE:
        ...
        break;
      case OPSOMA:
        jj_consume_token(OPSOMA);
             System.out.println("Operador soma: +");
        break;
      case OPSUB:
        jj_consume_token(OPSUB);
            System.out.println("Operador subtra\u00e7\u00e3o: -");
        break;
      case OPMULT:
        jj_consume_token(OPMULT);
             System.out.println("Operador multiplica\u00e7\u00e3o: *");
        break;
      case OPDIV:
        jj_consume_token(OPDIV);
            System.out.println("Operador divis\u00e3o: /");
        break;
      case OPAND:
      ...
      case OPOR:
        ...
        break;
      case OPMENORQ:
        jj_consume_token(OPMENORQ);
               System.out.println("Operador menor que: <");
        break;
      case OPMAIORQ:
        jj_consume_token(OPMAIORQ);
              System.out.println("Operador maior que: >");
        break;
      case OPIGUAL:
        jj_consume_token(OPIGUAL);
              System.out.println("Operador igualdade: ==");
        break;
      case OPCOMMA:
        jj_consume_token(OPCOMMA);
              System.out.println("Operador virgula: ,");
        break;
      case FUNCTION:
